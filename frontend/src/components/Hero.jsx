...
<<<<<<< HEAD
        ...
        <h1 className="font-mono font-bold leading-[1.05] mb-6">
          <span className="block text-5xl sm:text-6xl md:text-7xl text-white animate-fade-up delay-100">Code Together.</span>
          <span className="block text-5xl sm:text-6xl md:text-7xl text-cyan-400 glow-cyan animate-fade-up delay-200">Build Faster.</span>
        </h1>

        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-up delay-300">
          A real-time collaborative coding platform with shared main editor and personal workspace.
        </p>

        <div className="flex flex-wrap gap-4 justify-center mb-14 animate-fade-up delay-400">
          <Link to="/create-room" className="btn-primary flex items-center gap-2 text-base px-8 py-3.5">
            <Zap size={16} /> Create a Room
          </Link>
